...
if (isset($_POST['simpan'])) {
    ...
    if (isset($_FILES["gambar"]["tmp_name"]) && $_FILES["gambar"]["error"] == 0) {
...
<body>
    ...
    <?php if (isset($_GET['id'])) {
        $id = $_GET['id'];
        $cek = mysqli_query($conn, "SELECT * FROM sampah WHERE id='$id'");
        
        // Mengecek apakah query berhasil dan ada data yang ditemukan
