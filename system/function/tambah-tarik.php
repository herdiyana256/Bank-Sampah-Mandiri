<?php
 if (isset($_POST['simpan'])) {
  ...
  echo "<meta http-equiv='refresh'
   content='0; url=http://localhost/bank_sampah/bank_sampah/page/admin.php?page=data-nasabah-full'>";
  ...
  echo "<meta http-equiv='refresh'
   content='0; url=http://localhost/bank_sampah/bank_sampah/page/admin.php?page=tambah-data-tarik'>";
}
