...
<div class="sidebar">
    <ul>
        ...
        <!-- Menampilkan menu berdasarkan level -->
        <?php
            if ($_SESSION['level'] != 'Admin' && $_SESSION['level'] != 'Dinas Lingkungan Hidup') {
        ?>
        <li>
        ...
        <!-- Menampilkan menu berdasarkan level -->
        <?php
            if ($_SESSION['level'] != 'Dinas Lingkungan Hidup') {
        ?>
        <li>
       ...
       <!-- Menu untuk Dinas Lingkungan Hidup -->
<?php
    if ($_SESSION['level'] == 'Master-admin' || $_SESSION['level'] == 'Dinas Lingkungan Hidup') {
?>
<li>
    <a href="./status-distribusi-sampah.php"><span class="fa fa-line-chart" aria-hidden="true"></span>Status Distribusi Sampah</a>
</li>

<li>
    <a href="./rekapitulasi-sampah.php"><span class="fa fa-pie-chart" aria-hidden="true"></span>Rekapitulasi Sampah</a>
</li>
<?php } ?>
